...
public class MainActivity extends AppCompatActivity implements
    ...
    public void broadcastIntent() {
        ...
        intent.setComponent(new
                ComponentName(getPackageName(),"com.example.applicationbroadcastreceiver.Co nnectionReceiver"));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnExplicitBroadcast: broadcastIntent();
                break;
        }
    }
}
